...
urlpatterns = [
    ...
    path('api/v1/mobile/quset-answer/', mobile_views.mobile_quset_answer_insert, name='mobile_v1_quset_answer_insert'),
    path('api/v1/mobile/comments/<str:comment_id>/', mobile_views.mobile_comment_detail, name='mobile_v1_comment_detail'),
    path('api/v1/mobile/device/register/request/', mobile_views.mobile_device_register_request, name='mobile_v1_device_register'),
    ...
    path('app-collector-bind/<int:collector_id>/', collector_views.app_collector_bind_device, name='app_collector_bind_device'),
